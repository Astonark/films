...
@section('content')
    <div class="sm:container mx-auto">
        <form class="pt-8" method="post" action="{{ route('actor-store') }}">
            @csrf
            <div class="mb-6">
                <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Nom de l'acteur</label>
